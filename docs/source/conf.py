...
with open(os.path.join(root, 'md2docx', 'VERSION')) as f:
...
latex_documents = [
    (master_doc, 'md2docx.tex', 'md2docx Documentation',
     'Gio Piantoni', 'manual'),
]
...
man_pages = [
    (master_doc, 'md2docx', 'md2docx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'md2docx', 'md2docx Documentation',
     author, 'md2docx', 'One line description of project.',
     'Miscellaneous'),
]
